# The only purpose is to learn the use of buttons
# 1.Frame(): https://www.tutorialspoint.com/python/tk_frame.htm
# 2.Button(): https://www.tutorialspoint.com/python/tk_button.htm
# 3.grid(): https://www.pythontutorial.net/tkinter/tkinter-grid/
